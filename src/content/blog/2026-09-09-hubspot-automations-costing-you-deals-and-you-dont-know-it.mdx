...
<StatRow stats={[
  { number: "42%", label: "Avg unenrollment rate", description: "Median share of contacts that unenroll before completing a 5-step nurture workflow, based on audits I have run across clients on HubSpot Professional and Enterprise." },

...
<div class="quick-answer"><strong>Quick answer:</strong> Export your Substack CSV, clean it in a spreadsheet, import into <a href="/go/kit">Kit</a> with source tags, send a re-permission sequence before your first broadcast, and accept that paid subscriptions, Substack Recommendations, and archive URLs do not migrate automatically.</div>
...
<div style="display:grid;grid-template-columns:1fr;gap:1rem;">
  <style>{`
    @media (min-width: 900px) {
      .statrow-override { grid-template-columns: repeat(3, 1fr) !important; }
    }
    @media (min-width: 540px) and (max-width: 899px) {
      .statrow-override { grid-template-columns: repeat(2, 1fr) !important; }
    }
  `}</style>
</div>
...
<div style="display:grid;grid-template-columns:1fr;">
  <style>{`
    @media (min-width: 540px) {
      .steprow-override { grid-template-columns: repeat(2, 1fr) !important; }
    }
    @media (min-width: 900px) {
      .steprow-override { grid-template-columns: repeat(3, 1fr) !important; }
    }
  `}</style>
</div>

...
export const affiliateLinks: Record<string, AffiliateLink> = {
  ...
  // ---- Early-coverage batch, 2026-09-16 (see matching comment in tools.ts).
  // None applied yet; each falls back to homepage + UTM so /go/<slug> routes.
  nooks: {
    name: 'Nooks',
    url: '',
    homepageFallback: 'https://www.nooks.ai/',
    status: 'no-program',
    notes: 'Enterprise sales motion; no public self-serve affiliate program found as of 2026-09-16.',
  },
  orum: {
    name: 'Orum',
    url: '',
    homepageFallback: 'https://www.orum.com/',
    status: 'no-program',
    notes: 'Enterprise sales motion; no public self-serve affiliate program found as of 2026-09-16.',
  },
  rox: {
    name: 'Rox',
    url: '',
    homepageFallback: 'https://www.rox.com/',
    status: 'no-program',
    notes: 'Enterprise, $1.2B valuation as of the 3/2026 round; no public affiliate program found. Content-reference / trend-piece use more than a typical affiliate hub.',
  },
  'regie-ai': {
    name: 'Regie.ai',
    url: '',
    homepageFallback: 'https://www.regie.ai/',
    status: 'no-program',
    notes: 'No public self-serve affiliate program found as of 2026-09-16.',
  },
  octolane: {
    name: 'Octolane',
    url: '',
    homepageFallback: 'https://www.octolane.com/',
    status: 'no-program',
    notes: 'YC W24, seed-stage; no public affiliate program found as of 2026-09-16.',
  },
  elentaria: {
    name: 'Elentaria',
    url: '',
    homepageFallback: 'https://elentaria.ai/',
    status: 'no-program',
    notes: 'Launched June 2026, too new for a public affiliate program as of 2026-09-16.',
  },
  sherloq: {
    name: 'Sherloq',
    url: '',
    homepageFallback: 'https://www.gosherloq.com/',
    status: 'no-program',
    notes: 'Enterprise sales motion; no public affiliate program found. IMPORTANT: verify any future link points at gosherloq.com, not the unrelated sherloq.app (IBM Watson) product.',
  },
  reevo: {
    name: 'Reevo',
    url: '',
    homepageFallback: 'https://reevo.ai/',
    status: 'no-program',
    notes: 'No public self-serve affiliate program found as of 2026-09-16.',
  },
  lightfield: {
    name: 'Lightfield',
    url: '',
    homepageFallback: 'https://lightfield.app/',
    status: 'no-program',
    notes: 'Just raised a $47M Series A (a16z, 9/2026); no public affiliate program found as of 2026-09-16.',
  },
  leadfeeder: {
    name: 'Leadfeeder',
    url: '',
    homepageFallback: 'https://www.leadfeeder.com/',
    status: 'pending',
    notes: 'Real program confirmed 2026-09-16: PartnerStack, $100 one-time per referred customer after 2 paid months (leadfeeder.com/partners/). Not yet applied.',
  },
  '6sense': {
    name: '6sense',
    url: '',
    homepageFallback: 'https://6sense.com/',
    status: 'no-program',
    notes: 'Enterprise ABM platform; only agency/technology partner tiers found, no self-serve affiliate program, as of 2026-09-16.',
  },
  'lead-forensics': {
    name: 'Lead Forensics',
    url: '',
    homepageFallback: 'https://www.leadforensics.com/',
    status: 'no-program',
    notes: 'Agency/consultant partner program only, no self-serve affiliate signup found, as of 2026-09-16.',
  },
  uplead: {
    name: 'UpLead',
    url: '',
  ...
  lead411: {
    name: 'Lead411',
    url: '',
    homepageFallback: 'https://www.lead411.com/',
    status: 'no-program',
    notes: 'No public affiliate program found as of 2026-09-16.',
  },
  woodpecker: {
    name: 'Woodpecker',
    url: '',

...
export const affiliateLinks: Record<string, AffiliateLink> = {
  ...
  krispcall: {
    ...
    status: 'applied',
    notes: 'Applied 2026-08-19 (PartnerStack, ~30% lifetime), awaiting response.',
  },
  laxis: {
    name: 'Laxis',
  ...
  close: {
    ...
    status: 'applied',
    notes: 'Applied 2026-08-19 (PartnerStack, ~30% first 12mo), awaiting response.',
  },
  nutshell: {
    name: 'Nutshell',
    url: '',
    ...
    status: 'applied',
    notes: 'Applied 2026-08-19 (PartnerStack, ~20% recurring first year), awaiting response.',
  },
  getresponse: {
    name: 'GetResponse',
    url: '',
  ...
  fullenrich: {
    ...
    status: 'applied',
    notes: "Applied 2026-08-19 (PartnerStack, 15-25% tiered, 12mo, 90d cookie), awaiting response. Paid ads void payout.",
  },
  moltsets: {
    name: "MoltSets",
  ...
  activecampaign: {
    ...
    status: 'applied',
    notes: 'Applied 2026-08-19 (PartnerStack, 30% recurring 12mo), awaiting response.',
  },
  customerio: {
    name: 'Customer.io',
    url: '',

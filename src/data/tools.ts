...
export const tools: Tool[] = [
  ...
  // ---- Early-coverage batch, 2026-09-16: fast-emerging tools with real funding/
  // traction but thin or zero existing content coverage anywhere. Sourced from
  // GSC query demand (leadfeeder, 6sense) and 2026 funding/launch research
  // (the rest). All unlisted pending an affiliate-program check and first article.
  {
    slug: 'nooks',
    ...
    ctaPrimary: true,
    listed: false,
    aliases: ['Nooks', 'Nooks.ai', 'nooks.ai'],
    blurb:
      "Nooks is an AI parallel dialer and sales assistant platform: it dials multiple numbers at once, uses AI to detect live pickups so reps only talk to real people, then layers on AI call coaching and prospect research. Raised a $43M Series B and is the tool most often set against Orum in SDR team comparisons.",
    bestFor: 'Outbound SDR teams that want to compress dial time and add AI coaching without building a separate stack.',
  },
  {
    slug: 'orum',
    ...
    ctaPrimary: true,
    listed: false,
    aliases: ['Orum', 'orum.com'],
    blurb:
      'Orum is an AI-powered parallel dialer built for high-volume outbound calling, dialing 5 to 10 lines at once and connecting reps only when a real person answers. It leans enterprise and international, at a higher per-seat price than most dialers, and is the standard comparison point against Nooks.',
    bestFor: 'Larger SDR teams and enterprise orgs that need international dialing volume, not just US parallel dialing.',
  },
  {
    slug: 'rox',
    ...
    ctaPrimary: true,
    listed: false,
    aliases: ['Rox', 'Rox.com', 'rox.com'],
    blurb:
      'Rox is a warehouse-native AI revenue platform that runs one AI agent per account across the full deal lifecycle: prospecting, meeting scheduling, deal management, and renewals. It hit a $1.2B valuation in a March 2026 round led by General Catalyst, built for AI-native companies willing to use it as their system of record rather than a bolt-on to Salesforce or HubSpot.',
    bestFor: 'Fast-growing, AI-forward revenue teams evaluating a warehouse-native alternative to a CRM plus a stack of point tools.',
  },
  {
    slug: 'regie-ai',
    ...
    ctaPrimary: true,
    listed: false,
    aliases: ['Regie.ai', 'Regie', 'regie.ai'],
    blurb:
      'Regie.ai is an AI sales content and sequencing platform: it generates and personalizes outbound messaging at scale, then runs an AI SDR agent that adjusts sequences based on prospect behavior. It comes up repeatedly alongside Artisan and AiSDR in AI-SDR category roundups.',
    bestFor: 'RevOps and sales enablement teams that want AI-generated, on-brand sequence content plus autonomous sequence management.',
  },
  {
    slug: 'octolane',
    logo: '/brand/tools/octolane.png',
    name: 'Octolane',
    category: 'CRM',
    badge: 'Paid',
    ctaLabel: 'Try Octolane',
    ctaPrimary: true,
    listed: false,
    aliases: ['Octolane', 'Octolane AI', 'octolane.com'],
    blurb:
      'Octolane is a self-driving, chat-first CRM: it reads a rep\'s Gmail and Calendar activity, updates deal records automatically, and lets you manage pipeline with commands like "show me stuck deals" instead of manual data entry. A Y Combinator W24 company that raised $3.5M, built for founder-led and small B2B sales teams that live in email.',
    bestFor: 'Founder-led and small B2B sales teams (2 to 20 people) who want a CRM that updates itself.',
  },
  {
    slug: 'elentaria',
    ...
    ctaPrimary: true,
    listed: false,
    aliases: ['Elentaria', 'elentaria.ai'],
    blurb:
      'Elentaria is an AI GTM operator that analyzes a company across 22 outbound and marketing channels, picks the best-fit plays, and runs them end to end inside a team\'s existing stack, with a human GTM expert overseeing the system until it runs autonomously. Launched June 2026, positioned as an alternative to hiring a full growth team.',
    bestFor: 'Lean teams that want channel strategy and execution handled by one system instead of assembling point tools.',
  },
  {
    slug: 'sherloq',
    logo: '/brand/tools/sherloq.svg',
    name: 'Sherloq',
    category: 'Website Visitor ID & Signals',
    badge: 'Paid',
    ctaLabel: 'Try Sherloq',
    ctaPrimary: true,
    listed: false,
    aliases: ['Sherloq', 'gosherloq.com'],
    blurb:
      'Sherloq tracks LinkedIn buying signals for named accounts (competitor interactions, post engagement, job changes) and surfaces the moment a prospect goes warm, along with drafted outreach context. Built for enterprise sales teams with long cycles and high deal values. Note: the name collides with an unrelated IBM Watson purchase-intent product, so verify you are looking at gosherloq.com before writing about it.',
    bestFor: 'Enterprise AEs running named-account outbound who want LinkedIn signal timing without building it by hand.',
  },
  {
    slug: 'reevo',
    logo: '/brand/tools/reevo.png',
    name: 'Reevo',
    category: 'CRM',
    badge: 'Paid',
    ctaLabel: 'Try Reevo',
    ctaPrimary: true,
    listed: false,
    aliases: ['Reevo', 'reevo.ai'],
    blurb:
      'Reevo is an "agentic CRM" pitched as a full HubSpot replacement for growing teams, pairing pipeline management with AI agents that handle the busywork around deals. It shows up specifically in "what are startups switching to instead of HubSpot" writeups rather than generic CRM listicles.',
    bestFor: 'Teams that have outgrown a free HubSpot setup but do not want HubSpot\'s paid-tier complexity or price.',
  },
  {
    slug: 'lightfield',
    logo: '/brand/tools/lightfield.png',
    name: 'Lightfield',
    category: 'CRM',
    badge: 'Paid',
    ctaLabel: 'Try Lightfield',
    ctaPrimary: true,
    listed: false,
    aliases: ['Lightfield', 'lightfield.app', 'teamlightfield.com'],
    blurb:
      'Lightfield is an AI-native CRM built from scratch (not a bolt-on) by the founders of Tome, auto-capturing deal activity from email, meetings, and calls so reps never manually log anything. It raised a $47M Series A led by a16z in September 2026, with over 5,000 companies signed up and real Salesforce-replacement traction.',
    bestFor: 'Startups and growth-stage teams willing to trade CRM customization depth for zero manual data entry.',
  },
  {
    slug: 'leadfeeder',
    logo: '/brand/tools/leadfeeder.svg',
    name: 'Leadfeeder',
    category: 'Website Visitor ID & Signals',
    badge: 'Paid',
    ...
    bestFor: 'Teams that want deeper CRM and marketing-automation integrations than RB2B\'s simplicity, and do not mind a steeper price.',
  },
  {
    slug: '6sense',
    logo: '/brand/tools/6sense.png',
    name: '6sense',
    category: 'Website Visitor ID & Signals',
    badge: 'Enterprise',
    ctaLabel: 'Try 6sense',
    ctaPrimary: true,
    listed: false,
    aliases: ['6sense', '6sense.com'],
    blurb:
      '6sense is an enterprise account-based marketing and intent platform: it predicts which accounts are in-market using predictive analytics and buyer-intent signals, then feeds that into ABM and outbound workflows. It shows up as a comparison point against Lusha and other lighter-weight tools, though it operates at a different price tier and buying motion.',
    bestFor: 'Enterprise RevOps and ABM teams running account-based motions, not SMB teams looking for a lightweight signal tool.',
  },
  {
    slug: 'lead-forensics',
    logo: '/brand/tools/lead-forensics.png',
    name: 'Lead Forensics',
    category: 'Website Visitor ID & Signals',
    badge: 'Enterprise',
    ctaLabel: 'Try Lead Forensics',
    ctaPrimary: true,
    listed: false,
    aliases: ['Lead Forensics', 'leadforensics.com'],
    blurb:
      'Lead Forensics identifies the companies behind anonymous website traffic at the individual-visitor level, then routes qualified visits to sales as real-time alerts. One of the older, UK-founded players in visitor ID, sold mostly through an agency and consultant partner channel rather than self-serve signup.',
    bestFor: 'Teams that want a partner-supported visitor ID rollout rather than a self-serve tool.',
  },
  {
    slug: 'uplead',
    logo: '/brand/tools/uplead.png',
    name: 'UpLead',
    category: 'Lead Data & Enrichment',
    badge: 'Paid',
    ctaLabel: 'Try UpLead',
    ...
    bestFor: 'SMB teams that want verified contact data without ZoomInfo pricing and do not need Clay-style workflow automation.',
  },
  {
    slug: 'lead411',
    logo: '/brand/tools/lead411.png',
    name: 'Lead411',
    category: 'Lead Data & Enrichment',
    badge: 'Paid',
    ctaLabel: 'Try Lead411',
    ctaPrimary: true,
    listed: false,
    aliases: ['Lead411', 'lead411.com'],
    blurb:
      'Lead411 sells verified B2B contact data plus Bombora-powered buyer-intent signals, pitched explicitly as a cheaper alternative to ZoomInfo for teams that need intent data without the enterprise price tag. Entry pricing starts near $49/month.',
    bestFor: 'Budget-conscious teams that want intent signals bundled with contact data instead of buying them as separate tools.',
  },
  {
    slug: 'woodpecker',
    logo: '/brand/tools/woodpecker.png',
    name: 'Woodpecker',
    category: 'Cold Email & Deliverability',
    badge: 'Paid',
    ...
    bestFor: 'Freelancers, consultants, and small agencies sending modest cold email volume who do not want to pay for headroom they will not use.',
  },
  {
    slug: 'smartreach',

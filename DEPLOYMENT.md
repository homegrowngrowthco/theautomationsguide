...
|---|---|---|---|---|
| 2026-06-01 | direct | _pending commit_ | Affiliate pipeline: 20 unlisted `/tools/<slug>` landing pages (data + content + FAQ schema) + `listed` flag so they stay off homepage/grid; new `AFFILIATE_PIPELINE.md` tracker. Additive only. | `git revert <sha>` |

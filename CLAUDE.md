...
**Status:** Part 2 (cost logging) shipped + LIVE. Part 1 (PostHog) built + dry-run-validated, **blocked on Ian's PostHog personal API key** for the live apply. Both are additive and separately revertable.
